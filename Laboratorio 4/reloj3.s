...
alarma1: .word 0x0000000A // Variable compartida con el tiempo de espera
alarma2: .word 0x0000000C // Variable compartida con el tiempo de espera
tabla: .byte 0xBF,0x06,0x5B,0x4F,0x66
       .byte 0x6D,0xFD,0x07,0xFF,0xEF

Digitos: .byte 0x05,0x05,0x04,0x05,0x04,0x02
...
lazo3:
    ...
    CMP R2,R1
    ITTT EQ
    ORREQ R9,#(1 << LED_G_BIT)
    STREQ R9,[R8,#(LED_GPIO << 2)]
    BEQ stop
    LDR R2,=alarma2
    LDR R2,[R2]
    CMP R2,R1
